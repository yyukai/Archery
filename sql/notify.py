...
from sql.models import QueryPrivilegesApply, Users, SqlWorkflow, ResourceGroup, WorkflowAudit
...
def send_msg(audit_id, msg_type, **kwargs):
    ...
    p = Thread(target=notify, args=(audit_info, msg_type), kwargs=kwargs)
    p.start()
