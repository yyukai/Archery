...
from .models import Users, Instance, QueryExport, QueryPrivilegesApply, QueryPrivileges, QueryLog, ResourceGroup
    ...
    try:
        ...
        if SysConfig().sys_config.get('data_masking') and re.match(r"^select", sql_content.lower()):
            try:
                ...
                if SysConfig().sys_config.get('query_check') and query_result.is_critical is True:
